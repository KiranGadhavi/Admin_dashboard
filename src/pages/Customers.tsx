...
const arr: DataType[] =[
  ...
  {
    avatar:(
<img src={carronImg} style={{borderRadius: "50%",}}/>
    ),
    name: "Carron Smith",
  ...
  {
    avatar:(
<img src={emmaImg} style={{borderRadius: "50%",}}/>
    ),
    name: "Emma Parsh",
  ...
  {
    avatar:(
<img src={lizaImg} style={{borderRadius: "50%",}}/>
    ),
    name: "Liza Sin",
    ...
    avatar:(
<img src={meganImg} style={{borderRadius: "50%",}}/>
    ),
    name: "Megan Hunt",
